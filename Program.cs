...
var secretKey = jwtSettings["SecretKey"] ?? throw new InvalidOperationException("JWT SecretKey ÌÂ Ì‡ÒÚÓÂÌ");
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1.1",
        Description = "API ‰Îˇ ‡Ì‡ÎËÁ‡ ÒÂÚÂ‚Ó„Ó Ú‡ÙËÍ‡ Ò ML-ÍÎ‡ÒÚÂËÁ‡ˆËÂÈ"
    });
