...
namespace TrafficAnalysisAPI.Migrations
{
    ...
    [Migration("20251012140321_InitialCreate")]
            ...
            modelBuilder.Entity("TrafficAnalysisAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$Zx8H1qGKp5L2rN8dK7vZx.YQ3L5mB9Kp2fH7nJ4xR6tW8yV3cA1Bm",
                            Role = "Admin",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            PasswordHash = "$2a$11$xB5yL8Np2K6fR9tM3vJ7c.WQ2L4mA8Jp1eG6mI3wP5rU7xT2bZ0Am",
                            Role = "Analyst",
                            Username = "analyst"
                        });
                });
